    ...
    <main className="min-h-screen overflow-x-hidden bg-[#fbf7ef] text-[#16130f]">
      <section className="mx-auto grid min-h-screen w-full max-w-[1440px] gap-6 px-4 py-6 sm:px-6 lg:grid-cols-[1.05fr_.95fr] lg:px-8">
        <div className="flex flex-col justify-between gap-8 py-6">
          <div>
            <span className="inline-flex px-3 py-2 text-xs font-black uppercase tracking-[0.16em] text-white" style={{ backgroundColor: "#e07a1f" }}>Copilot workspace</span>
            <h1 className="mt-6 max-w-4xl text-5xl font-black leading-none sm:text-7xl">AI Email Assistant</h1>
            <p className="mt-6 max-w-2xl text-lg leading-8 opacity-70">An email assistant starter for reply drafting, tone control, and inbox triage.</p>
          </div>
